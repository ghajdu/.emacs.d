...
(define-key smartparens-mode-map (kbd "C-M-s") (defhydra smartparens-hydra ()
                                                 "Smartparens"
                                                 ("d" sp-down-sexp "Down")
                                                 ("e" sp-up-sexp "Up")
...
(define-key smartparens-mode-map (kbd "H-p") 'sp-prefix-pair-ocbject)
...
(define-key smartparens-mode-map (kbd "H-e") 'sp-przefix-save-excursion)
...
(define-key smartparens-mode-map (kbd "H-s r") 'sp-raise-sexp )
